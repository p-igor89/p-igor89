...
<!-- ═══════════════════════════════════════════════════════════════════════════
     ВАРИАНТ 1: ABOUT ME - Более личный стиль
     ═══════════════════════════════════════════════════════════════════════════ -->
...
<!-- ═══════════════════════════════════════════════════════════════════════════
     СТАРЫЙ ВАРИАНТ ABOUT (закомментирован):
...
- Automation workflows with n8n (eliminating repetitive tasks)
...
<!-- ═══════════════════════════════════════════════════════════════════════════
     ВАРИАНТ BADGES: СТИЛЬ "FLAT" (современный, минималистичный)
     ═══════════════════════════════════════════════════════════════════════════ -->
...
![Locust](https://img.shields.io/badge/Locust-006600?style=flat&logo=locust&logoColor=white)
...
![Allure](https://img.shields.io/badge/Allure-FF5722?style=flat&logo=allure&logoColor=white)
![TestomatIO](https://img.shields.io/badge/Testomat.io-4A154B?style=flat&logoColor=white)
...
**Also Experienced With** *(legacy but still relevant)*

![Selenium](https://img.shields.io/badge/Selenium-43B02A?style=flat&logo=selenium&logoColor=white)
![Selenoid](https://img.shields.io/badge/Selenoid-4B8BBE?style=flat&logoColor=white)
![BrowserStack](https://img.shields.io/badge/BrowserStack-FF6C37?style=flat&logo=browserstack&logoColor=white)

<!-- ═══════════════════════════════════════════════════════════════════════════
     ВАРИАНТ BADGES: СТИЛЬ "FOR-THE-BADGE" (крупнее, заметнее)
     Раскомментируй этот блок чтобы посмотреть
     ═══════════════════════════════════════════════════════════════════════════

### Tech Stack (FOR-THE-BADGE style)
...
<!-- ═══════════════════════════════════════════════════════════════════════════
     ВАРИАНТ BADGES: СТИЛЬ "FLAT-SQUARE" (строгий, корпоративный)
     Раскомментируй этот блок чтобы посмотреть
     ═══════════════════════════════════════════════════════════════════════════
...
![Locust](https://img.shields.io/badge/Locust-006600?style=flat-square&logo=locust&logoColor=white)
![Postman](https://img.shields.io/badge/Postman-FF6C37?style=flat-square&logo=postman&logoColor=white)

     ═══════════════════════════════════════════════════════════════════════════ -->

<!-- ═══════════════════════════════════════════════════════════════════════════
     СТАРЫЙ ВАРИАНТ С ИКОНКАМИ (закомментирован):
...
<p align="left">
  <a href="mailto:p_ihor@hotmail.com">
    <img src="https://img.shields.io/badge/Email-D14836?style=flat&logo=gmail&logoColor=white" />
  </a>
  <a href="https://linkedin.com/in/ihor-peretiatko" target="_blank">
    <img src="https://img.shields.io/badge/LinkedIn-0077B5?style=flat&logo=linkedin&logoColor=white" />
  </a>
  <a href="https://t.me/p_ihor89" target="_blank">
    <img src="https://img.shields.io/badge/Telegram-2CA5E0?style=flat&logo=telegram&logoColor=white" />
  </a>
  <a href="https://github.com/p-igor89" target="_blank">
    <img src="https://img.shields.io/badge/GitHub-181717?style=flat&logo=github&logoColor=white" />
  </a>
</p>

<!-- ═══════════════════════════════════════════════════════════════════════════
     СТАРЫЙ ВАРИАНТ SOCIALS (закомментирован):
